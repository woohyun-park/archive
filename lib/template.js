...
function createHTML(){
  ...
  <body>
    <container>
      ...
      <main id="main">
        ${list[1]}
        <div class="main__content" id="cinema">
          <div class="main__box">
            <img src="/style?id=./img/cinema/1.png">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/cinema/2.png">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/cinema/3.png">
          </div>
        </div>
        <div class="main__content" id="music">
          <div class="main__box">
            <img src="/style?id=./img/music/1.jpg">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/music/2.jpg">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/music/3.jpg">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/music/1.jpg">
          </div>
        ...
        <div class="main__content" id="fashion">
          <div class="main__box">
            <img src="/style?id=./img/fashion/1.png">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/fashion/2.png">
          </div>
          <div class="main__box">
            <img src="/style?id=./img/fashion/3.png">
          </div>
        </div>
