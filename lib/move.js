...
function moveTop(self, i){
  ...
  let currentContent = document.getElementsByClassName("main__content");
  currentContent[i-1].style.display = "flex";
  setTimeout(function(){
    currentContent[i-1].style.marginTop = "10vh";
    setTimeout(function(){
...
function moveBottom(i){
  ...
  console.log(i);
  currentContent[i].style.marginTop = "110vh";
  document.getElementsByTagName("body")[0].style.overflow = "hidden";
  setTimeout(function(){
    currentContent[i].style.display = "none";
  }, 500)
}
